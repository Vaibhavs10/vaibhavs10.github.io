...
As these models continue to become smaller, it's more likely that you can run inference directly on your device. Hence, I continue to keep an eye out for smaller models. 

The big question here, is what use-cases do you actually use these on-device models for?

I use them for a few select task, like, rewriting, summarizing, quick syntax lookups, or just quick vibe checks on a topic (asking the model to critique what I've written).

![Chatting with Phi 3.5 on my Macbook](examples.png)
