...
author: "VB"
date: "2025-08-13"
description: "Build browser-automating AI agents with MCP and gpt-oss. From web scraping to Hugging Face Spaces integration."
categories: [mcp, openai, gpt-oss, tiny-agents, playwright, huggingface, huggingface-mcp, browser-automation]
---

> [!NOTE]
> This post is to be accompanied by it's GitHub repository [here](https://github.com/Vaibhavs10/mcp-with-openai-gpt-oss)
...
![CLI Init Browser](https://huggingface.co/datasets/reach-vb/random-images/resolve/main/init-browser.png)
...
![Hugging Face MCP Settings page](https://huggingface.co/datasets/reach-vb/random-images/resolve/main/hf-mcp.png)
