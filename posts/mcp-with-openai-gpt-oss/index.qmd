...
![CLI Init Browser](https://huggingface.co/datasets/reach-vb/random-images/raw/main/init-browser.png)
...
![Hugging Face MCP Settings page](https://huggingface.co/datasets/reach-vb/random-images/raw/main/hf-mcp.png)
