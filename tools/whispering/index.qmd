    ...
    <header class="whisper-pad__header">
      ...
      <div class="stack">
        ...
        <select id="model-select" aria-label="Choose model">
          <option value="onnx-community/whisper-tiny.en">whisper-tiny.en (fastest)</option>
          <option value="onnx-community/whisper-base.en">whisper-base.en (better)</option>
          <option value="onnx-community/whisper-small.en">whisper-small.en (best, slowest)</option>
          <option value="onnx-community/whisper-large-v3">whisper-large-v3 (very high quality, heavy)</option>
        </select>
      </div>
  ...
  <div class="whisper-card">
    ...
    <div class="llm-row">
      <label class="toggle">
        ...
        <span>Auto-fix punctuation (Qwen3 0.6B)</span>
      </label>
...
<script type="module">
  ...
  async function loadLLM() {
    ...
    try {
      ...
      llm = await pipeline('text-generation', 'onnx-community/Qwen3-0.6B-DQ-ONNX', {
        device,
        dtype: supportsWebGPU ? 'q4f16' : 'q8',
        // Inline configs to avoid missing generation_config.json in the ONNX repo.
        config: qwenConfig,
        generation_config: qwenGeneration,
      });
